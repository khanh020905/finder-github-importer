...
export const EventCard = ({ event }: EventCardProps) => {
  ...
  // Use a nice placeholder if no image
  const imageUrl = `https://images.unsplash.com/photo-${event.id === "1" ? "1501281668745-f7f57925c3b4" : event.id === "2" ? "1492684223066-81342ee5ff30" : "1540575861501-7ad060e1c27c"}?auto=format&fit=crop&q=80&w=800`;
